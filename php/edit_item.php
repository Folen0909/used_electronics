    ...
    <section class="details">
        ...
        <form action="validate_edit_item.php" method="post">
            ...
            <p>
                ...
                <input class="textinput" id="edit_input" type="text" name="item_name" id="item_name" value="<?php echo $item_name ?>">
            </p>
            <p>
            ...
            <p>
                ...
                <input class="textinput" id="edit_input" type="number" name="item_price" id="item_price" value="<?php echo $item_price ?>">
            </p>
